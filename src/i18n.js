...
const TRANSLATIONS = {
  es: {
    ...
    'dash.welcome':         'Bienvenido a Memorix',
    'dash.no_activity_sub': 'Todavía no hay actividad registrada. Empieza añadiendo parcelas o difuntos.',
    'empty.no_deceased':  'Todavía no hay difuntos registrados.',
    'empty.add_deceased': 'Añadir primer difunto',
    'empty.no_plots':     'Todavía no hay parcelas registradas.',
    'empty.add_plot':     'Añadir primera parcela',
    ...
    // Config card: Licencia
    'cfg.license_title':      'Licencia',
    'cfg.license_sub':        'Estado de tu suscripción',
    'cfg.lic_active':         '● Activa',
    'cfg.lic_perpetual':      'Licencia perpetua',
    'cfg.lic_expires':        'Expira:',
    'cfg.lic_days':           'días',
    'cfg.lic_no_license':     'Sin licencia activa',
    'cfg.lic_deactivate':     'Desactivar licencia',
    'cfg.lic_deact_title':    'Desactivar licencia',
    'cfg.lic_deact_msg':      'Esto eliminará la licencia de este dispositivo. Necesitarás tu clave para volver a activarla.',
    'cfg.lic_deact_confirm':  'Desactivar',
    'cfg.lic_deact_cancel':   'Cancelar',
    'cfg.lic_deact_done':     'Licencia desactivada. La app se cerrará.',
    ...
    'login.default_hint': 'La contraseña por defecto es <strong>1234</strong>. Cámbiala desde Configuración.',
    ...
    'ob.sample_title':    'Datos de ejemplo incluidos',
    'ob.sample_desc':     'Hemos añadido 6 parcelas y 4 difuntos de muestra para que puedas explorar la app. Puedes borrarlos cuando quieras desde Configuración.',
    'ob.next':            'Siguiente →',
    'ob.start':           'Comenzar →',
  ...
  en: {
    ...
    'dash.welcome':         'Welcome to Memorix',
    'dash.no_activity_sub': 'No activity yet. Start by adding plots or deceased records.',
    'empty.no_deceased':  'No deceased records yet.',
    'empty.add_deceased': 'Add first record',
    'empty.no_plots':     'No plots registered yet.',
    'empty.add_plot':     'Add first plot',
    ...
    // Config card: License
    'cfg.license_title':      'License',
    'cfg.license_sub':        'Your subscription status',
    'cfg.lic_active':         '● Active',
    'cfg.lic_perpetual':      'Perpetual license',
    'cfg.lic_expires':        'Expires:',
    'cfg.lic_days':           'days',
    'cfg.lic_no_license':     'No active license',
    'cfg.lic_deactivate':     'Deactivate license',
    'cfg.lic_deact_title':    'Deactivate license',
    'cfg.lic_deact_msg':      'This will remove the license from this device. You will need your key to reactivate it.',
    'cfg.lic_deact_confirm':  'Deactivate',
    'cfg.lic_deact_cancel':   'Cancel',
    'cfg.lic_deact_done':     'License deactivated. The app will close.',
    ...
    'login.default_hint': 'The default password is <strong>1234</strong>. Change it from Settings.',
    ...
    'ob.sample_title':    'Sample data included',
    'ob.sample_desc':     'We\'ve added 6 sample plots and 4 deceased records so you can explore the app. You can delete them anytime from Settings.',
    'ob.next':            'Next →',
