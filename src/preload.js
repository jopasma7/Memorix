...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    // Etiquetas
    seedEtiquetas:    (lang) => ipcRenderer.invoke('etiquetas-seed', lang),
    seedSampleData:   (lang) => ipcRenderer.invoke('sample-data-seed', lang),
    ...
    onActivationIcon:   (cb) => ipcRenderer.on('activation-icon',   (_e, url)    => cb(url)),
    onLicenseExpiringSoon: (cb) => ipcRenderer.on('license-expiring-soon', (_e, days) => cb(days)),

    // Shell
    openExternal: (url) => ipcRenderer.invoke('open-external', url),
    openManual: (file) => ipcRenderer.invoke('open-manual', file),
