...
const LEMONSQUEEZY_STORE_ID   = '380693';
const LEMONSQUEEZY_PRODUCT_ID = '1068946';
...
function verifyWithLemonSqueezy(licenseKey) {
    return new Promise((resolve, reject) => {
        const body = `license_key=${encodeURIComponent(licenseKey)}&instance_name=${encodeURIComponent('memorix-desktop')}`;
...
async function activate(licenseKey) {
    ...
    // Verificar que la licencia corresponde a este producto
    if (res.meta?.product_id?.toString() !== LEMONSQUEEZY_PRODUCT_ID) {
